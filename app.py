...
with st.sidebar:
    ...
    # Fetch cities from Prolog for safer selection
...
if go:
    with st.spinner("Reasoning with Prolog and building your route..."):
        try:
            ...
            st.error('Prolog error. Ensure SWI-Prolog (swipl) is installed and inputs are valid.')
